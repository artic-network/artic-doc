...
Initial genomes have been sequenced with [Twist Comprehensive Viral Panel](https://www.twistbioscience.com/products/ngs/fixed-panels/comprehensive-viral-research-panel) (DRC) or Illumina Viral Surveillance Panel V2 (Uganda) and Illumina sequencing which has generated reliable sequencing results with high coverage (\>99%) from samples with Cts ranging between 17-25.  This approach, whilst effective, is expensive to run at scale due to the high costs of the bait capture kit. The 12 reaction kit costs approximately £15,000, meaning the minimim cost is around £150 per sample.
