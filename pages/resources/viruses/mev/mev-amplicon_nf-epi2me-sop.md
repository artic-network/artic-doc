---
title: MEV Bioinformatics Analysis using the local EPI2ME client | amplicon
keywords: protocol
layout: document
last_updated: {{ "now" | date: "%Y-%m-%d %H:%M" }}
tags:
  - protocol
permalink: /viruses/mev/mev-amplicon_nf-epi2me-sop.html
folder: mev
title_text: MEV Bioinformatics Analysis using the local EPI2ME client
subtitle_text: Nanopore | Illumina | Bioinformatics
document_name: ARTIC-MEV-bioinformaticsSOP ARTIC-MEV-amplicon_nf-epi2me-SOP
version: v1.0.0
...
> [!WARNING]
> This SOP assumes that you have installed and configured the EPI2ME client, if you have not please see the [epi2me desktop client setup guide](/viruses/mev/mev-ont-epi2me-sop.html) for instructions to do so!
...
![](/images/amplicon-nf/epi2me_welcome_screen.png)
...
![](/images/amplicon-nf/epi2me_continue_as_guest.png)
...
![](/images/amplicon-nf/epi2me_log_in_screen.png)
...
![](/images/amplicon-nf/epi2me_workflows_tab.png)
...
![](/images/amplicon-nf/epi2me_workflows_import.png)
...
![](/images/amplicon-nf/epi2me_workflows_downloaded.png)
...
![](/images/amplicon-nf/epi2me_workflows_amp_nf_installed.png)
To begin configuring the pipeline, press it, you will see an options menu which looks like this:
![](/images/amplicon-nf/epi2me_amp-nf_launch.png)
...
![](/images/amplicon-nf/epi2me_amp-nf_params.png)
...
![](/images/amplicon-nf/epi2me_amp-nf_samplesheet.png)
...
### Pipeline Settings
* `Normalise Depth` -> This controls to what depth the pipeline will try to normalise your data to before running variant calling, if you set this to 0 the pipeline will not run normalisation at all which will increase your runtime significantly due to the increased complexity of basecalling.
...
![](/images/amplicon-nf/epi2me_amp-nf_params_expanded.png)
...
![](/images/amplicon-nf/epi2me_amp-nf_running.png)
...
![](/images/amplicon-nf/epi2me_amp-nf_completed.png)
