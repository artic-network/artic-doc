...
{% include link-out.html url="https://labs.epi2me.io/downloads/" text="EPI2ME downloads: https://labs.epi2me.io/downloads/" image="/pages/training/workshops/lhf/installing/images/epi2me_1.png" max-width="50%" caption="ONT's download page for EPI2ME." %}
...
{% include image.html file="epi2me_2.png" prefix=root_url max-width=480 %}
...
{% include image.html file="epi2me_4.png" prefix=root_url max-width=480 %}

Click on "Import workflow" in the top right of the window, and then "Import from GitHub":

{% include image.html file="epi2me_5.png" prefix=root_url max-width=480 %}
...
{% include image.html file="epi2me_6.png" prefix=root_url max-width=480 %}

If the workflow installed correctly, should see the following message:

{% include image.html file="epi2me_7.png" prefix=root_url max-width=480 %}

Click "Open" to open the workflow:

{% include image.html file="epi2me_8.png" prefix=root_url max-width=480 %}
...
{% include image.html file="epi2me_9.png" prefix=root_url max-width=480 %}
...
{% include image.html file="download_file.png" prefix=root_url max-width=480 %}

<br />

Click on the 'amplicon-nf' workflow to open it:

{% include image.html file="amplicon-nf_1.png" prefix=root_url max-width=480 %}

Click the 'Launch' button to start an instance of this workflow:

{% include image.html file="amplicon-nf_2.png" prefix=root_url max-width=480 %}
...
{% include image.html file="amplicon-nf_3.png" prefix=root_url max-width=480 %}
...
{% include image.html file="amplicon-nf_4.png" prefix=root_url max-width=480 %}

Finally, click the "Launch Workflow" button:

{% include image.html file="amplicon-nf_5.png" prefix=root_url max-width=480 %}

The workflow will start running:

{% include image.html file="amplicon-nf_6.png" prefix=root_url max-width=480 %}

If everything is setup then it will show that it has completed successfully:

{% include image.html file="amplicon-nf_7.png" prefix=root_url max-width=480 %}

If you get to this stage then the workflow is installed and ready to run on real data.

### 4. Testing the raccoon-nf

Repeat the steps above to test the **raccoon-nf** workflow.

Click on the 'raccoon-nf' workflow to open it:

{% include image.html file="raccoon-nf_1.png" prefix=root_url max-width=480 %}
...
{% include image.html file="raccoon-nf_2.png" prefix=root_url max-width=480 %}

Finally click the "Launch workflow" button and wait until the workflow completes:

{% include image.html file="raccoon-nf_3.png" prefix=root_url max-width=480 %}
