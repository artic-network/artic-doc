...
{% include image.html file="images/tutorials/phylogram_1.png" max-width="70%" caption="" %}
...
{% include image.html file="images/tutorials/phylogram_1a.png" max-width="70%" caption="" %}
...
{% include image.html file="images/tutorials/phylogram_1b.png" max-width="70%" caption="" %}
...
<div style="display: flex; flex-wrap: wrap; justify-content: center;">
    <div style="width: 48%">
A: {% include image.html file="images/tutorials/phylogram_2.png" max-width="100%" caption="" %}
    </div>
    <div style="width: 48%">
B: {% include image.html file="images/tutorials/phylogram_3.png" max-width="100%" caption="" %}
    </div>
</div>
...
{% include image.html file="images/tutorials/phylogram_3.png" max-width="70%" caption="" %}
...
<div style="display: flex; flex-wrap: wrap; justify-content: center;">
    <div style="width: 48%">
{% include image.html file="images/tutorials/phylogram_4a.png" max-width="100%" caption="" %}
    </div>
    <div style="width: 48%">
{% include image.html file="images/tutorials/phylogram_4b.png" max-width="100%" caption="" %}
    </div>
</div>
...
{% include image.html file="images/tutorials/phylogram_4c.png" max-width="70%" caption="" %}
...
<div style="display: flex; flex-wrap: wrap; justify-content: center;">
    <div style="width: 32%">
{% include image.html file="images/tutorials/phylogram_5a.png" max-width="100%" caption="" %}
    </div>
    <div style="width: 32%">
{% include image.html file="images/tutorials/phylogram_5b.png" max-width="100%" caption="" %}
    </div>
    <div style="width: 32%">
{% include image.html file="images/tutorials/phylogram_5c.png" max-width="100%" caption="" %}
    </div>
</div>
